...
final class torus_utils_swiftTests: XCTestCase {
    ...
    var tempVerifierId = "somethingtest@goog.com"
...
//            result = data
    ...
    func testGetPublicAddress(){
        ...
        let getpublicaddress = try! fd.getPublicAddress(endpoints: ["https://lrc-test-13-a.torusnode.com/jrpc", "https://lrc-test-13-b.torusnode.com/jrpc", "https://lrc-test-13-c.torusnode.com/jrpc", "https://lrc-test-13-d.torusnode.com/jrpc", "https://lrc-test-13-e.torusnode.com/jrpc"], torusNodePubs: nodePubKeys, verifier: "google", verifierId: tempVerifierId)
