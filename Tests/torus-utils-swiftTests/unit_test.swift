...
final class torus_utils_swiftTests: XCTestCase {
    ...
    let verifier = "google"
    let token = "eyJhbGciOiJSUzI1NiIsImtpZCI6Ijc0YmQ4NmZjNjFlNGM2Y2I0NTAxMjZmZjRlMzhiMDY5YjhmOGYzNWMiLCJ0eXAiOiJKV1QifQ..jBrY9ov3Ra-MuKc61dDLPomsxTObbTiuiSjO0-JUdNo6hkWEkXKd1Vsp38E_5azdarm_0KYfh_mm0ONt4Rz3dbjPQcF_fhGS9elzHaH06eCaf8a0r9t4PRJWkYXbfBT3hgADGbmHjOh5zUjwno1qzkLCoZGq-i00N9CIIgvyHvBRJsUtw3D2XvUad6Db3TPQEhoIdVm0wEURtUC-UOSuUa5-WuIvquE9AKyWhRCWbY3VvtD-3PMH4tFEtCzeUjlPHtoufMtaDzkzwBJpnIor_tcDDjvzw7L2iQeOL6zvUzYwh_GTfPbUfUbK_ZG8Mt7b6YiCLBbAs9xhPIxaqiKvkw"
...
//        }
    ...
    //    func returnPromise() -> Promise<String>{
//        let (tempPromise, seal) = Promise<String>.pending()
//
//        returnAnoterPromise().done{ data in
//            print(data + "ASDF")
//            seal.fulfill(data)
//        }
//        return tempPromise
//    }
//
//    func returnAnoterPromise() -> Promise<String>{
//        return Promise<String>.value("completed")
//    }
