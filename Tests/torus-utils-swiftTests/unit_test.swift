...
final class torus_utils_swiftTests: XCTestCase {
    ...
    func testKeyLookup() {
        ...
        let exp1 = XCTestExpectation(description: "Do keylookup")
        ...
        let exp2 = XCTestExpectation(description: "Do keylookup")
    ...
    func testKeyAssign(){
        let expectations = XCTestExpectation(description: "Do keyAssign")
        let obj = Torus()
